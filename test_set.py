...
test_cases = '''rnb1kb1r/p4p2/1qp1pn2/1p2N2p/2p1P1p1/2N3B1/PPQ1BPPP/3RK2R w Kkq - bm Ng6; id "ERET 009 - Knight Sacrifice";
...
for test_case in test_cases:
    ...
    if "bm" in test_case[0]:
        fen = test_case[0].split('bm')[0].strip()
    elif "am" in test_case[0]:
        fen = test_case[0].split('am')[0].strip()

    parts = fen.split()

    # EPD-style: pieces side castling enpassant -
    ...
    id = test_case[1].strip()
    parsed_test_cases[id] = fen
